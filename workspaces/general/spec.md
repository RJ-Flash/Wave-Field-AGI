# Core Objectives
- Create a visualization for file dependencies.
- Build a generic UI component explorer for the Design System.
- Integrate Deep Vector RAG search capabilities for global files.
